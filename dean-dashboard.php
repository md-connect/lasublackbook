...
<div class="dashboard-wrapper">
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Dean's Dashboard</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            $sql = "SELECT * FROM users WHERE usertype='dean student affairs' OR usertype='SDC'";
